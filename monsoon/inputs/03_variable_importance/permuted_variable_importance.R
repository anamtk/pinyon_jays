...
beta_samples <- readRDS("/scratch/atm234/pinyon_jays/ebird/nospuncert/outputs/ebird_abund_model_covariate_effect_samples.RDS")
...
rmse_samples <- readRDS("/scratch/atm234/pinyon_jays/ebird/nospuncert/outputs/ebird_abund_model_RMSE_samples.RDS")
...
predict_fun(sample = 1, covariate = "PinyonBA")
...
saveRDS(importance_df_all,
        file = "/scratch/atm234/pinyon_jays/ebird/nospuncert/outputs/ebird_abund_model_permutedimportance_samples.RDS")
