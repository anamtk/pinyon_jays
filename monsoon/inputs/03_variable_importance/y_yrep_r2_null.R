...
yrep_samps <- readRDS("/scratch/atm234/pinyon_jays/ebird/nospuncert/outputs/ebird_abund_model_yrepsamples_null.RDS")
...
saveRDS(r2_df, "/scratch/atm234/pinyon_jays/ebird/nospuncert/outputs/ebird_abund_model_yyrepr2_null.RDS")
