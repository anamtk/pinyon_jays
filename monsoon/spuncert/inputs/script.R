...
data <- readRDS("/scratch/atm234/pinyon_jays/spuncert/inputs/bbs_ebird_joint_data_list.RDS")
...
inits_list <- readRDS('/scratch/atm234/pinyon_jays/spuncert/inputs/bbs_ebird_joint_init_list.RDS')
...
model <- jagsUI::jags(data = data_list,
                      ...
                      inits = inits_list,
                      model.file = '/scratch/atm234/pinyon_jays/spuncert/inputs/ebird_bbs_joint_abund_JAGS_spuncert2.R',
                      parallel = TRUE,
                      n.chains = 3,
                      n.iter = 1,
                      #n.burnin = 5000,
...
saveRDS(model, 
        file ="/scratch/atm234/pinyon_jays/spuncert/outputs/ebird_bbs_joint_abund_model.RDS")
...
mcmcplot(model$samples,
         dir = "/scratch/atm234/pinyon_jays/spuncert/outputs/mcmcplots/test")